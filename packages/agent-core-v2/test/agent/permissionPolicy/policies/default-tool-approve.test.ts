...
describe('DefaultToolApprovePermissionPolicyService', () => {
  ...
  it.each([
    ...
    ['BraveWebSearch', { q: 'kimi code' }],
    ['BraveNewsSearch', { q: 'kimi code' }],
    ['BraveImageSearch', { q: 'kimi code' }],
    ['BraveVideoSearch', { q: 'kimi code' }],
    ['BraveLLMContext', { q: 'kimi code' }],
    ['BraveAnswers', { messages: [{ role: 'user', content: 'kimi code' }] }],
    ['BraveSuggest', { q: 'kimi code' }],
    ['BraveSpellcheck', { q: 'kimi code' }],
    ['BraveLocalSearch', { q: 'kimi code' }],
    ['BraveRichResults', { q: 'kimi code' }],
    ...
    ['Workflow', { name: 'deep-research', args: 'auth token refresh' }],

...
- Use `../../bin/kimi-slides check --level auto` to check out-of-bounds, overflow, overlap, and structural issues; use `../../bin/kimi-slides screenshot` to check visual focus, reading order, contrast, font sizes, and image cropping.
...
- After fixing problem pages, check and screenshot again, and only then deliver the validated PPTD directory with preview screenshots or output images.

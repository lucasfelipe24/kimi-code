...
- [ ] `../../bin/kimi-slides check --level auto` reports no errors; page-by-page screenshots show no overlap, no cropping, no overflow, no unexpected line wraps; dark-background white-text contrast passes.
- [ ] Final deliverable: the complete validated PPTD bundle + `final-screenshots/pages/1.jpg~6.jpg`.
